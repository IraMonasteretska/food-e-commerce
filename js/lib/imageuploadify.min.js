(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let totalFiles = [];
            let counter = 0;
            let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"></div><div class="imageuploadify-images-list text-center"><button type="button"class="btn btn-default"><span class="addphoto">Add Photos 5MB maximum size</span><span class="addphotovideo">Add Photos or Video 5MB maximum size</span></button></div></div>`);
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(`<div class='imageuploadify-container'><button type='button'class='btn btn-danger glyphicon glyphicon-remove'></button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div><div class="uploadradio"><label><input type="radio" name="uplfoto" id="${id}"><span>Use as a preview</span></label></div></div>`);
